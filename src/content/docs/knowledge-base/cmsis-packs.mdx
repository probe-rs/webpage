...
Since doing all of this by hand would be madness, we provide a utility called [target-gen](https://github.com/probe-rs/probe-rs/tree/master/target-gen) which can be used to
